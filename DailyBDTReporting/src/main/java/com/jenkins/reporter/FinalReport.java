...
public class FinalReport {
	...
	public FinalReport(int dataSetId, String product, String jenkinsBuildNumber, String buildRepo, String buildBranch,
			...
			String testDuration, String testStatus, String testing_type, String qADeploymentStatus) {
		super();
	...
	public String toString() {
		return "FinalReport [dataSetId=" + dataSetId + ", product=" + product + ", jenkinsBuildNumber="
				+ jenkinsBuildNumber + ", buildRepo=" + buildRepo + ", buildBranch=" + buildBranch
				+ ", buildGeneratedBy=" + buildGeneratedBy + ", buildStartDate=" + buildStartDate + ", buildDuration="
				+ buildDuration + ", buildStatus=" + buildStatus + ", destination_path=" + destination_path
				+ ", destination_server=" + destination_server + ", deploymentStatus=" + deploymentStatus
				+ ", deploymentStartDate=" + deploymentStartDate + ", deploymentDuration=" + deploymentDuration
				+ ", total_tc=" + total_tc + ", passed_tc=" + passed_tc + ", failed_tc=" + failed_tc + ", skipped_tc="
				+ skipped_tc + ", testDuration=" + testDuration + ", testStatus=" + testStatus + ", testing_type="
				+ testing_type + ", qADeploymentStatus=" + qADeploymentStatus + "]";
	}
