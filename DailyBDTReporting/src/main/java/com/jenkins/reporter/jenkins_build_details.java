...
public class jenkins_build_details {
	...
	public jenkins_build_details(String id, BigInteger duration, Date enddate, String fullname, String name,
	...
	public String toString() {
		return "jenkins_build_details [id=" + id + ", duration=" + duration + ", enddate=" + enddate + ", fullname="
