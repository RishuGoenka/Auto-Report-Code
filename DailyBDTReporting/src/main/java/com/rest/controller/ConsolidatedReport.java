...
import com.jenkins.database.TestDataSessionFactoryForPostgreSQL;
...
public class ConsolidatedReport {
	...
	public static final String IANALYZE = "iAnalyze";
	...
	public static void consolidatedFinalReportForAllProuct() {
		try {
			TestDataSessionFactoryForPostgreSQL.getSessionFactory();
			...
			productMapping.put(JENKINS_API + IANALYZE + BDTD_API, IANALYZE);
			...
			System.out.println("consolidatedFinalReportForAllProuct : Somthing is wrong");
		}
	}
